    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300">Start building AI-powered podcasts today</p>
        </div>
        ...
        <div className="bg-slate-800 border border-white/10 rounded-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center">
              <input type="checkbox" className="w-4 h-4 rounded border-gray-600 bg-slate-900 text-purple-600 focus:ring-purple-500" required />
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center space-x-2 bg-white/10 hover:bg-white/20 text-white py-3 rounded-lg transition">
        ...
        <div className="mt-8 bg-slate-800/50 border border-white/10 rounded-xl p-6">
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            <li className="flex items-center">✓ 1 podcast channel</li>
            <li className="flex items-center">✓ 5 episodes per month</li>
            <li className="flex items-center">✓ Basic AI voices</li>
            <li className="flex items-center">✓ No credit card required</li>
          </ul>
        </div>
      </div>
    </div>
